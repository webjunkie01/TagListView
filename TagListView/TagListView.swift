...
public class TagListView: UIView {
     ...
     public dynamic var textColor: UIColor = UIColor.whiteColor() {
        didSet {
     ...
     public dynamic var selectedTextColor: UIColor = UIColor.whiteColor() {
        didSet {
            for tagView in tagViews {
     ...
     public dynamic var tagBackgroundColor: UIColor = UIColor.grayColor() {
        didSet {
            for tagView in tagViews {
     ...
     public dynamic var tagHighlightedBackgroundColor: UIColor? {
        didSet {
            for tagView in tagViews {
     ...
     public dynamic var tagSelectedBackgroundColor: UIColor? {
        didSet {
            for tagView in tagViews {
     ...
     public dynamic var selectedBorderColor: UIColor? {
        didSet {
            for tagView in tagViews {
     ...
     public dynamic var paddingY: CGFloat = 2 {
        didSet {
            for tagView in tagViews {
     ...
     public dynamic var paddingX: CGFloat = 5 {
        didSet {
            for tagView in tagViews {
     ...
     public dynamic var marginY: CGFloat = 2 {
        didSet {
            rearrangeViews()
        }
    }
     public dynamic var marginX: CGFloat = 5 {
        didSet {
            rearrangeViews()
        }
    }
    ...
    @objc public enum Alignment: Int {
     ...
     public dynamic var shadowColor: UIColor = UIColor.whiteColor() {
        didSet {
            rearrangeViews()
        }
    }
     public dynamic var shadowRadius: CGFloat = 0 {
        didSet {
            rearrangeViews()
        }
    }
     public dynamic var shadowOffset: CGSize = CGSizeZero {
        didSet {
            rearrangeViews()
        }
    }
     public dynamic var shadowOpacity: Float = 0 {
        didSet {
            rearrangeViews()
        }
    }

     public dynamic var enableRemoveButton: Bool = false {
        didSet {
            for tagView in tagViews {
     ...
     public dynamic var removeButtonIconSize: CGFloat = 12 {
        didSet {
            for tagView in tagViews {
     ...
     public dynamic var removeIconLineWidth: CGFloat = 1 {
        didSet {
            for tagView in tagViews {
     ...
     public dynamic var removeIconLineColor: UIColor = UIColor.whiteColor().colorWithAlphaComponent(0.54) {
        didSet {
            for tagView in tagViews {
