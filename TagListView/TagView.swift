...
public class TagView: UIButton {
     ...
     public var selectedTextColor: UIColor = UIColor.whiteColor() {
        didSet {
            reloadStyles()
        }
    }
     ...
     public var tagBackgroundColor: UIColor = UIColor.grayColor() {
        didSet {
            reloadStyles()
        }
    }
    ...
    let removeButton = CloseButton()
     ...
     public var enableRemoveButton: Bool = false {
        didSet {
     ...
     public var removeButtonIconSize: CGFloat = 12 {
        didSet {
     ...
     public var removeIconLineColor: UIColor = UIColor.whiteColor().colorWithAlphaComponent(0.54) {
        didSet {
